...
import com.leary.marvelheroesapp.Presentation.Screans.HeroScrean.HeroScrean
import com.leary.marvelheroesapp.Presentation.Screans.HeroScrean.HeroScreanViewModel
import com.leary.marvelheroesapp.Presentation.Screans.HeroScrollScrean.HeroScrollScrean
import com.leary.marvelheroesapp.Presentation.Screans.HeroScrollScrean.HeroScrollViewModel
    ...
    NavHost(
        ...
        composable(route = HeroesScreen.SingleHero.name){
            HeroScrean(
                ...
                onAction = { action ->navController.navigateUp()
                    heroScreanViewModel.onAction(action)}
            )
        }
    }
